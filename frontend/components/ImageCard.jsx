...
export default function ImageCard({ job, onClick, draggable = false, onDragStart }) {
  ...
  // Type label icon
  const typeIcons = {
    FRONT: <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4h10l3 5-2 1v10H6V10L4 9l3-5z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 4v1a3 3 0 006 0V4" /></svg>,
    BACK: <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4h10l3 5-2 1v10H6V10L4 9l3-5z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 4h6" /></svg>,
    DETAIL: <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" /></svg>,
    SPEC_LABEL: <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" /></svg>,
    UNKNOWN: <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/5] bg-[var(--bg-surface)] overflow-hidden">
        ...
        {/* Type badge (top left) */}
        {imageType !== "UNKNOWN" && (
          <div className="absolute top-2 left-2 px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-white/95 backdrop-blur-md text-[var(--text-primary)] shadow-[0_2px_8px_rgba(0,0,0,0.12)] border border-[var(--border)] flex items-center gap-1.5 transition-transform hover:scale-105">
        ...
        {confidence != null && confidence > 0 && (
          <div className="absolute top-2 right-2 px-2 py-1 rounded-full text-[10px] font-mono font-bold bg-white/95 backdrop-blur-md text-[var(--text-primary)] shadow-[0_2px_8px_rgba(0,0,0,0.12)] border border-[var(--border)]">
